...
to rank cars objectively based on the provided data. The app normalizes, weights, and analyzes input to identify the most suitable car.
""")
...
if st.button("Run Analysis"):
    ...
    if matrix_data.isnull().values.any():
        ...
        st.markdown(f"**✅ The best car based on analysis is: {best_car}**")
        ...
        eval_results["Rank"] = np.argsort(-scores) + 1
